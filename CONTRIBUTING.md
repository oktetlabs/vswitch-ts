...
# Contributing code to Virtual Switches Test Suite

The document provides the guidelines for submitting changes to VSwitch TS.
...
The summary line should:
 ...
 - start with the imperative of a verb, for example:
   ...
   ```
   conf: increase CPU number in generic VM template
   ```

   ```
   scripts: support an option to steal configuration
   ```
